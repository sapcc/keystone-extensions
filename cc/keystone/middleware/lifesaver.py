...
class LifesaverMiddleware(wsgi.Middleware):
    def __init__(self, app, conf):
        ...
        CONF.register_opt(cfg.StrOpt('user_allowlist', default=conf.get('user_allowlist', 'keystone'),help='Users thart are allowlisted'), group=group)
        CONF.register_opt(cfg.StrOpt('user_blocklist', default=conf.get('user_blocklist', ''), help='Users thart are blocklisted'),group=group)
